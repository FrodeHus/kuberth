...
type FakeDnsEntries struct {
	Fake *FakeKuberthV1alpha1
	ns   string
}

var dnsentriesResource = schema.GroupVersionResource{Group: "kuberth.io", Version: "v1alpha1", Resource: "dnsentries"}

var dnsentriesKind = schema.GroupVersionKind{Group: "kuberth.io", Version: "v1alpha1", Kind: "DnsEntry"}
